...
public class QPlaceImage extends EntityPathBase<PlaceImage> {
    ...
    private static final long serialVersionUID = 1974427542L;
    ...
    public final NumberPath<Integer> placeImageId = createNumber("placeImageId", Integer.class);

    public final StringPath placeImageUrl = createString("placeImageUrl");
